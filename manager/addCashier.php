...
if (isset($_POST['addCashier']) ) {
    ...
    if(!$error){
			...
			if ($result == 1) {
				...
				<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times</a>Un utilisateur a été ajouté avec succès.</div>";
			}
		}
	}
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="text-uppercase m-2">Ajouter utilisateur</h1>
                        </div>
                        <!-- /.col -->
                        <!-- /.col -->
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" 
                                        ...
                                        <button type="submit"
                                            name="addCashier"
											id="addCashier"
                                            class="btn btn-outline-primary btn-lg w-100 text-uppercase">Ajouter
                                            </button>
                                    </form>
                                </div>
                            </div>
